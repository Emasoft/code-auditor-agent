...
| Report | Filename |
|--------|----------|
| Correctness (per-domain) | `reports/code-auditor/caa-correctness-P{N}-R{RUN_ID}-{uuid}.md` |
| Claim verification | `reports/code-auditor/caa-claims-P{N}-R{RUN_ID}-{uuid}.md` |
| Security review | `reports/code-auditor/caa-security-P{N}-R{RUN_ID}-{uuid}.md` |
| Skeptical review | `reports/code-auditor/caa-review-P{N}-R{RUN_ID}-{uuid}.md` |
| Agent manifest | `reports/code-auditor/caa-agents-P{N}-R{RUN_ID}.json` |
| Merged intermediate | `reports/code-auditor/caa-pr-review-P{N}-intermediate-{timestamp}.md` |
| Final dedup report | `reports/code-auditor/caa-pr-review-P{N}-{timestamp}.md` |
| Fix checkpoint (per-domain) | `reports/code-auditor/caa-checkpoint-P{N}-R{RUN_ID}-{domain}.json` |
| Fix summary (per-domain) | `reports/code-auditor/caa-fixes-done-P{N}-{domain}.md` |
| Test outcome | `reports/code-auditor/caa-tests-outcome-P{N}.md` |
| Per-group fix issues | `reports/code-auditor/caa-fix-group-{GROUP_ID}.md` |
| Per-group lint | `reports/code-auditor/caa-lint-group-{GROUP_ID}.md` |
| Per-group security | `reports/code-auditor/caa-security-group-{GROUP_ID}.md` |
| Per-group review | `reports/code-auditor/caa-review-group-{GROUP_ID}.md` |
| Lint outcome (joined) | `reports/code-auditor/caa-lint-outcome-P{N}.md` |
| Recovery log | `reports/code-auditor/caa-recovery-log-P{N}.md` |
| Final clean report | `reports/code-auditor/caa-pr-review-and-fix-FINAL-{timestamp}.md` |
| Escalation (if max reached) | `reports/code-auditor/caa-pr-review-and-fix-escalation-{timestamp}.md` |
...
REPORT_PATH="reports/code-auditor/caa-correctness-P${PASS}-R${RUN_ID}-${UUID}.md"
```
