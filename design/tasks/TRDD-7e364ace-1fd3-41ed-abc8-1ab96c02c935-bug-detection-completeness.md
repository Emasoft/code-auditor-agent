...
| 21 — domain specialists (LF) | ✅ 8 agents shipped (caa-ios-reviewer / caa-elixir-reviewer / caa-solidity-reviewer / caa-mcp-server-reviewer / caa-i18n-reviewer / caa-l10n-reviewer / caa-monorepo-reviewer / caa-logging-reviewer) — each gated on Step-0 domains_detected, each with focused 8-item checklist | (pending commit) |
